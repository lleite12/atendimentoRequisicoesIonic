...
/* harmony import */ var xml2js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! xml2js */ "./node_modules/xml2js/lib/xml2js.js");
/* harmony import */ var xml2js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(xml2js__WEBPACK_IMPORTED_MODULE_8__);
...
let LoginPage = class LoginPage {
    ...
    convertXmltoJson(data, op) {
        xml2js__WEBPACK_IMPORTED_MODULE_8___default.a.parseString(data, { explicitArray: false }, (error, result) => {
            if (error) {
    ...
    getCallProcedure() {
        ...
        let nativeCall = this.nativeHttp.post(this.testBaseURL, this.param2, {
            ...
            let aux = data.data;
            xml2js__WEBPACK_IMPORTED_MODULE_8___default.a.parseString(aux, { explicitArray: false }, (error, result) => {
                if (error) {
                    throw new Error(error);
                }
                else {
                    ...
                    if (this.VALUE1 == "OK") {
                        this.hideSpinner();
                        _app_module__WEBPACK_IMPORTED_MODULE_3__["AppModule"].setUsuar(this.user);
                        this.user = "";
                        this.pass = "";
...
LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_4__["HTTP"],
